...
import com.sdau.hotelsystem.core.*;
...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(SessionManager sessionManager, RedisCacheManager redisCacheManager,@Qualifier("myRealm") MyRealm myRealm) {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager, OutSessionControlFilter outSessionControlFilter) {
